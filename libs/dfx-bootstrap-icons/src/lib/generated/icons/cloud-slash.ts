 ...
 */
export const cloudSlash = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-slash" viewBox="0 0 16 16">
  ...
  <path d="m13.646 14.354-12-12 .708-.708 12 12z"></path>
</svg>`;
