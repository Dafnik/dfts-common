 ...
 */
export const signIntersectionSide = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sign-intersection-side" viewBox="0 0 16 16">
  <path d="M6.25 4v8h1.5V8.75H11v-1.5H7.75V4h-1.5Z"></path>
