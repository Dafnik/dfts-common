 ...
 */
export async function thr_sleep(milliseconds: number): Promise<unknown> {
 ...
 * @param milliseconds How long the thread sleeps
 */
export function thr_block(milliseconds: number): void {
