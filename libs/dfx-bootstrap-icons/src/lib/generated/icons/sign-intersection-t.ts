 ...
 */
export const signIntersectionT = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sign-intersection-t" viewBox="0 0 16 16">
  <path d="M5 5v1.5h2.25V12h1.5V6.5H11V5H5Z"></path>
